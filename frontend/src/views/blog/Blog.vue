...
<template>
    <div class="light-theme">
      ...
      <header>
        ...
        <div class="container">
          ...
          <nav class="navbar">
            ...
            <a href="#">
              <img :src="require('@/assets/images/logo-light.svg')" alt="Devblog's logo" width="150" class="logo-light">
              <img :src="require('@/assets/images/logo-dark.svg')" alt="Devblog's logo" width="150" class="logo-dark">
            </a>
        ...
        <div class="hero">
          ...
          <div class="container">
            ...
            <div class="right">
              ...
              <div class="img-box">
                <img :src="require('@/assets/images/hero.png')" alt="Julia Walker" class="hero-img">
      ...
      <footer>
        ...
        <p class="copyright">
          &copy; Copyright 2024 <a href="#">RangerTech</a>
        </p>
